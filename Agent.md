...
## Python Environment
- Project environment: `backend/.venv`
- Use `uv run ...` from `backend/` or `backend/.venv/bin/python`.
- Do not run this project's API with another project's Conda environment.
